...
Before you start, ensure you have the following:
    ...
    It's crucial to create the required Kafka topics beforehand. The topics should include those expected by the application for consuming messages. Topics are defined within the MessageTopics enum, located in src/types/messageTypes.ts.
...
We can extend the application with more services:
    ...
    Include kafka topic for the service within the MessageTopics enum, located in src/types/messageTypes.ts.

    Import and use your service in src/index.ts based on specific kafka topic.
